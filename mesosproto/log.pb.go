...
func (m *Action_Append) Unmarshal(data []byte) error {
	...
	for index < l {
		...
		case 1:
			...
			m.Bytes = append(m.Bytes, data[index:postIndex]...)
			index = postIndex
		case 2:
			if wireType != 2 {
				return code_google_com_p_gogoprotobuf_proto.ErrWrongType
			...
			m.Cksum = append(m.Cksum, data[index:postIndex]...)
			index = postIndex
		default:
			var sizeOfWire int
			for {
...
func (this *Promise) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Promise{` + `Proposal:` + valueToGoStringLog(this.Proposal, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Action) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Action{` + `Position:` + valueToGoStringLog(this.Position, "uint64"), `Promised:` + valueToGoStringLog(this.Promised, "uint64"), `Performed:` + valueToGoStringLog(this.Performed, "uint64"), `Learned:` + valueToGoStringLog(this.Learned, "bool"), `Type:` + valueToGoStringLog(this.Type, "mesosproto.Action_Type"), `Nop:` + fmt1.Sprintf("%#v", this.Nop), `Append:` + fmt1.Sprintf("%#v", this.Append), `Truncate:` + fmt1.Sprintf("%#v", this.Truncate), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Action_Nop) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Action_Nop{` + `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Action_Append) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Action_Append{` + `Bytes:` + valueToGoStringLog(this.Bytes, "byte"), `Cksum:` + valueToGoStringLog(this.Cksum, "byte"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Action_Truncate) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Action_Truncate{` + `To:` + valueToGoStringLog(this.To, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Metadata) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Metadata{` + `Status:` + valueToGoStringLog(this.Status, "mesosproto.Metadata_Status"), `Promised:` + valueToGoStringLog(this.Promised, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *Record) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.Record{` + `Type:` + valueToGoStringLog(this.Type, "mesosproto.Record_Type"), `Promise:` + fmt1.Sprintf("%#v", this.Promise), `Action:` + fmt1.Sprintf("%#v", this.Action), `Metadata:` + fmt1.Sprintf("%#v", this.Metadata), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *PromiseRequest) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.PromiseRequest{` + `Proposal:` + valueToGoStringLog(this.Proposal, "uint64"), `Position:` + valueToGoStringLog(this.Position, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *PromiseResponse) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.PromiseResponse{` + `Okay:` + valueToGoStringLog(this.Okay, "bool"), `Proposal:` + valueToGoStringLog(this.Proposal, "uint64"), `Position:` + valueToGoStringLog(this.Position, "uint64"), `Action:` + fmt1.Sprintf("%#v", this.Action), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func (this *WriteResponse) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.WriteResponse{` + `Okay:` + valueToGoStringLog(this.Okay, "bool"), `Proposal:` + valueToGoStringLog(this.Proposal, "uint64"), `Position:` + valueToGoStringLog(this.Position, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *LearnedMessage) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.LearnedMessage{` + `Action:` + fmt1.Sprintf("%#v", this.Action), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *RecoverRequest) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.RecoverRequest{` + `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
func (this *RecoverResponse) GoString() string {
	...
	s := strings1.Join([]string{`&mesosproto.RecoverResponse{` + `Status:` + valueToGoStringLog(this.Status, "mesosproto.Metadata_Status"), `Begin:` + valueToGoStringLog(this.Begin, "uint64"), `End:` + valueToGoStringLog(this.End, "uint64"), `XXX_unrecognized:` + fmt1.Sprintf("%#v", this.XXX_unrecognized) + `}`}, ", ")
	return s
}
...
func extensionToGoStringLog(e map[int32]code_google_com_p_gogoprotobuf_proto1.Extension) string {
	if e == nil {
		return "nil"
	}
...
func (this *Promise) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Promise")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Promise but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Promisebut is not nil && this == nil")
	}
	if this.Proposal != nil && that1.Proposal != nil {
		if *this.Proposal != *that1.Proposal {
			return fmt2.Errorf("Proposal this(%v) Not Equal that(%v)", *this.Proposal, *that1.Proposal)
		}
	} else if this.Proposal != nil {
		return fmt2.Errorf("this.Proposal == nil && that.Proposal != nil")
...
func (this *Action) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Action")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Action but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Actionbut is not nil && this == nil")
	}
	if this.Position != nil && that1.Position != nil {
		if *this.Position != *that1.Position {
			return fmt2.Errorf("Position this(%v) Not Equal that(%v)", *this.Position, *that1.Position)
		}
	} else if this.Position != nil {
		return fmt2.Errorf("this.Position == nil && that.Position != nil")
	} else if that1.Position != nil {
		return fmt2.Errorf("Position this(%v) Not Equal that(%v)", this.Position, that1.Position)
	}
	if this.Promised != nil && that1.Promised != nil {
		if *this.Promised != *that1.Promised {
			return fmt2.Errorf("Promised this(%v) Not Equal that(%v)", *this.Promised, *that1.Promised)
		}
	} else if this.Promised != nil {
		return fmt2.Errorf("this.Promised == nil && that.Promised != nil")
	} else if that1.Promised != nil {
		return fmt2.Errorf("Promised this(%v) Not Equal that(%v)", this.Promised, that1.Promised)
	}
	if this.Performed != nil && that1.Performed != nil {
		if *this.Performed != *that1.Performed {
			return fmt2.Errorf("Performed this(%v) Not Equal that(%v)", *this.Performed, *that1.Performed)
		}
	} else if this.Performed != nil {
		return fmt2.Errorf("this.Performed == nil && that.Performed != nil")
	} else if that1.Performed != nil {
		return fmt2.Errorf("Performed this(%v) Not Equal that(%v)", this.Performed, that1.Performed)
	}
	if this.Learned != nil && that1.Learned != nil {
		if *this.Learned != *that1.Learned {
			return fmt2.Errorf("Learned this(%v) Not Equal that(%v)", *this.Learned, *that1.Learned)
		}
	} else if this.Learned != nil {
		return fmt2.Errorf("this.Learned == nil && that.Learned != nil")
	...
	if !this.Nop.Equal(that1.Nop) {
		return fmt2.Errorf("Nop this(%v) Not Equal that(%v)", this.Nop, that1.Nop)
	}
	if !this.Append.Equal(that1.Append) {
		return fmt2.Errorf("Append this(%v) Not Equal that(%v)", this.Append, that1.Append)
	}
	if !this.Truncate.Equal(that1.Truncate) {
		return fmt2.Errorf("Truncate this(%v) Not Equal that(%v)", this.Truncate, that1.Truncate)
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt2.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
	}
...
func (this *Action_Nop) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Action_Nop")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Action_Nop but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Action_Nopbut is not nil && this == nil")
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt2.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
	}
...
func (this *Action_Append) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Action_Append")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Action_Append but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Action_Appendbut is not nil && this == nil")
	}
	if !bytes.Equal(this.Bytes, that1.Bytes) {
		return fmt2.Errorf("Bytes this(%v) Not Equal that(%v)", this.Bytes, that1.Bytes)
	}
	if !bytes.Equal(this.Cksum, that1.Cksum) {
		return fmt2.Errorf("Cksum this(%v) Not Equal that(%v)", this.Cksum, that1.Cksum)
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt2.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
	}
...
func (this *Action_Truncate) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Action_Truncate")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Action_Truncate but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Action_Truncatebut is not nil && this == nil")
	}
	if this.To != nil && that1.To != nil {
		if *this.To != *that1.To {
			return fmt2.Errorf("To this(%v) Not Equal that(%v)", *this.To, *that1.To)
		}
	} else if this.To != nil {
		return fmt2.Errorf("this.To == nil && that.To != nil")
...
func (this *Metadata) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Metadata")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Metadata but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Metadatabut is not nil && this == nil")
	}
	if this.Status != nil && that1.Status != nil {
		if *this.Status != *that1.Status {
			return fmt2.Errorf("Status this(%v) Not Equal that(%v)", *this.Status, *that1.Status)
		}
	} else if this.Status != nil {
		return fmt2.Errorf("this.Status == nil && that.Status != nil")
...
func (this *Record) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *Record")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *Record but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *Recordbut is not nil && this == nil")
	}
	if this.Type != nil && that1.Type != nil {
		if *this.Type != *that1.Type {
			return fmt2.Errorf("Type this(%v) Not Equal that(%v)", *this.Type, *that1.Type)
	...
	if !this.Promise.Equal(that1.Promise) {
		return fmt2.Errorf("Promise this(%v) Not Equal that(%v)", this.Promise, that1.Promise)
	}
	if !this.Action.Equal(that1.Action) {
		return fmt2.Errorf("Action this(%v) Not Equal that(%v)", this.Action, that1.Action)
	}
	if !this.Metadata.Equal(that1.Metadata) {
		return fmt2.Errorf("Metadata this(%v) Not Equal that(%v)", this.Metadata, that1.Metadata)
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt2.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
	}
...
func (this *PromiseRequest) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *PromiseRequest")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *PromiseRequest but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *PromiseRequestbut is not nil && this == nil")
	}
	if this.Proposal != nil && that1.Proposal != nil {
		if *this.Proposal != *that1.Proposal {
			return fmt2.Errorf("Proposal this(%v) Not Equal that(%v)", *this.Proposal, *that1.Proposal)
...
func (this *PromiseResponse) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *PromiseResponse")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *PromiseResponse but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *PromiseResponsebut is not nil && this == nil")
	}
	if this.Okay != nil && that1.Okay != nil {
		if *this.Okay != *that1.Okay {
			return fmt2.Errorf("Okay this(%v) Not Equal that(%v)", *this.Okay, *that1.Okay)
		}
	} else if this.Okay != nil {
		return fmt2.Errorf("this.Okay == nil && that.Okay != nil")
...
func (this *WriteRequest) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *WriteRequest")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *WriteRequest but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *WriteRequestbut is not nil && this == nil")
	}
	if this.Proposal != nil && that1.Proposal != nil {
		if *this.Proposal != *that1.Proposal {
			return fmt2.Errorf("Proposal this(%v) Not Equal that(%v)", *this.Proposal, *that1.Proposal)
...
func (this *WriteResponse) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *WriteResponse")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *WriteResponse but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *WriteResponsebut is not nil && this == nil")
	}
	if this.Okay != nil && that1.Okay != nil {
		if *this.Okay != *that1.Okay {
			return fmt2.Errorf("Okay this(%v) Not Equal that(%v)", *this.Okay, *that1.Okay)
...
func (this *LearnedMessage) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *LearnedMessage")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *LearnedMessage but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *LearnedMessagebut is not nil && this == nil")
	}
	if !this.Action.Equal(that1.Action) {
		return fmt2.Errorf("Action this(%v) Not Equal that(%v)", this.Action, that1.Action)
	}
...
func (this *RecoverRequest) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *RecoverRequest")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *RecoverRequest but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *RecoverRequestbut is not nil && this == nil")
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return fmt2.Errorf("XXX_unrecognized this(%v) Not Equal that(%v)", this.XXX_unrecognized, that1.XXX_unrecognized)
	}
...
func (this *RecoverResponse) VerboseEqual(that interface{}) error {
	...
	if !ok {
		return fmt2.Errorf("that is not of type *RecoverResponse")
	}
	if that1 == nil {
		if this == nil {
			return nil
		}
		return fmt2.Errorf("that is type *RecoverResponse but is nil && this != nil")
	} else if this == nil {
		return fmt2.Errorf("that is type *RecoverResponsebut is not nil && this == nil")
	}
	if this.Status != nil && that1.Status != nil {
		if *this.Status != *that1.Status {
			return fmt2.Errorf("Status this(%v) Not Equal that(%v)", *this.Status, *that1.Status)
	...
	if this.Begin != nil && that1.Begin != nil {
		if *this.Begin != *that1.Begin {
			return fmt2.Errorf("Begin this(%v) Not Equal that(%v)", *this.Begin, *that1.Begin)
		}
	} else if this.Begin != nil {
		return fmt2.Errorf("this.Begin == nil && that.Begin != nil")
	} else if that1.Begin != nil {
		return fmt2.Errorf("Begin this(%v) Not Equal that(%v)", this.Begin, that1.Begin)
	}
	if this.End != nil && that1.End != nil {
		if *this.End != *that1.End {
			return fmt2.Errorf("End this(%v) Not Equal that(%v)", *this.End, *that1.End)
		}
	} else if this.End != nil {
		return fmt2.Errorf("this.End == nil && that.End != nil")
